...
class Pannellum extends PureComponent {
    ...
    if (Array.isArray(hotspots)) {
      hotspots.map((hotspot) => {
        switch (hotspot.props.type) {
          ...
          case "custom":
            return hotspotArray.push({
              draggable: hotspot.props.draggable ? hotspot.props.draggable : false,
              id: Math.random().toString(36).substr(2, 9),
              pitch: hotspot.props.pitch ? hotspot.props.pitch : 10,
              yaw: hotspot.props.yaw ? hotspot.props.yaw : 10,
              ...
              dragHandlerFunc: hotspot.props.handleDrag ? hotspot.props.handleDrag : this.handleDragHotspot,
              dragHandlerArgs: hotspot.props.handleDragArg ? hotspot.props.handleDragArg : { name: "test" },
            });
          default:
            return [];
        }
  ...
  handleDragHotspot = (e, args) => {
    console.log("hotspot dragged", args.name);
  };
